...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
   The differences between describe() and it() are essentially in the way the tests are outputed to the console. Describe is best to be used for seperate functions/componenents with multiple individual it() unit tests relavent to the component in the describe(). Jest outputs this to the console in a very clean way showing which suites passed or failed and which individual tests passed or failed.

1. What is the point of `Test Driven Development`? What do you think about this approach?
   The point of test driven development is to write strong tests before writing any code so that, after writing your code, you can be confident when the tests pass that the code is error free.

1. Mention three types of automated tests.
   Three types of automated tests are unit tests, integration tests and component testing
